...
<!-- Mirrored from booking.webestica.com/ by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 02 Dec 2023 15:49:42 GMT -->
<head>
...
<header class="navbar-light header-sticky">
	...
	<nav class="navbar navbar-expand-xl">
        ...
        <span class="d-none d-sm-inline-block small">Menu</span>
						...
						<ul class="dropdown-menu" aria-labelledby="listingMenu">
							...
							<li class="dropdown-submenu dropend">
								...
								<ul class="dropdown-menu" data-bs-popper="none">
									<li> <a class="dropdown-item" href="index-2.html">Hotel Home</a></li>
          ...
          <!-- Nav item link-->
					<li class="nav-item dropdown">
						<a class="nav-link dropdown-toggle" href="#" id="pagesMenu" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Services</a>
						<ul class="dropdown-menu min-w-auto" data-bs-popper="none">
							<li> 
								<a class="dropdown-item" href="https://support.webestica.com/" target="_blank">
									<i class="text-warning fa-solid fa-hotel me-2"></i>Packers & Movers
								</a> 
							</li>
							<li> 
								<a class="dropdown-item" href="docs/index.html" target="_blank">
									<i class="text-danger fa-solid fa-file-text me-2"></i>Rental Agreement
								</a> 
							</li>
							<li> <hr class="dropdown-divider"></li>
							<li> 
								<a class="dropdown-item" href="rtl/index.html" target="_blank">
									<i class="text-info fa-solid fa-blind me-2"></i>Home Cleaning
								</a> 
							</li>
							<li> 
								<a class="dropdown-item" href="https://themes.getbootstrap.com/store/webestica/" target="_blank">
									<i class="text-success fa-solid fa-bug me-2"></i>Pest Control
								</a> 
							</li>
							<li> <hr class="dropdown-divider"></li>
							<li> 
								<a class="dropdown-item" href="docs/alerts.html" target="_blank">
									<i class="text-orange fa-solid fa-book me-2"></i>Rent Receipt Generator
								</a> 
							</li>
						</ul>
					</li>
					...
					<li class="nav-item dropdown">
						...
						<ul class="dropdown-menu" aria-labelledby="pagesMenu">
							...
							<li> <a class="dropdown-item" href="contact-2.html">Blog</a></li>
							<li> <a class="dropdown-item" href="team.html">Help Center</a></li>
                            <li> <a class="dropdown-item" href="team.html">Refund Policy</a></li>
                            <li> <a class="dropdown-item" href="team.html">Privacy Policy</a></li>
                            <li> <a class="dropdown-item" href="team.html">Terms of Use</a></li>
                        </ul>
					</li>
				</ul>
			</div>
			...
			<div class="navbar-collapse collapse" id="navbarCategoryCollapse">
				<ul class="navbar-nav navbar-nav-scroll nav-pills-primary-soft text-center ms-auto p-2 p-xl-0">
					<!-- Nav item Hotel -->
					<li class="nav-item"> <a class="nav-link active" href="index-2.html"><i class="fa-solid fa-hotel me-2"></i>Property</a>	</li>

					<!-- Nav item Flight -->
					<li class="nav-item"> <a class="nav-link" href="index-flight.html"><i class="fa-solid fa-home me-2"></i>Interior</a>	</li>

					<!-- Nav item Tour -->
					<li class="nav-item"> <a class="nav-link" href="index-tour.html"><i class="fa-solid fa-chair me-2"></i>Furniture</a> </li>
                </ul>
			</div>
	...
	<div class="container">
		...
		<div class="row g-4">
			...
			<div class="col-lg-3">
				...
				<p class="mb-2"><a href="#" class="text-body-secondary text-primary-hover"><i class="bi bi-telephone me-2"></i>6292324256</a> </p>
				<p class="mb-0"><a href="#" class="text-body-secondary text-primary-hover"><i class="bi bi-envelope me-2"></i>catchifo@gmail.com</a></p>
			</div>
			<!-- Widget 1 END -->
		...
		<div class="row">
			<div class="container">
				<div class="d-lg-flex justify-content-between align-items-center py-3 text-center text-lg-start">
					<!-- copyright text -->
					<div class="text-body-secondary text-primary-hover"> Copyrights &copy;2023 Catchifo. </div>
					<!-- copyright links-->
...
<div class="navbar navbar-mobile">
	<ul class="navbar-nav">
		<!-- Nav item Home -->
		<li class="nav-item">
			<a class="nav-link active" href="index-2.html"><i class="bi bi-house-door fa-fw"></i>
